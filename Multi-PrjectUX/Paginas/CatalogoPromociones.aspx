<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/HeaderMasterPage.Master" AutoEventWireup="true" CodeBehind="CatalogoPromociones.aspx.cs" Inherits="Multi_PrjectUX.Paginas.CatalogoPromociones" %>
		...
		<section class="wn__portfolio__area gallery__masonry__activation bg--white mt--40 pb--100">
			<div class="container-fluid">
				...
				<div class="row masonry__wrap">
                    <% 
                        foreach (var item in cargarProductosPromo())
                        {%>
